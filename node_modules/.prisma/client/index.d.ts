...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "user" | "query" | "response"
    ...
    model: {
      ...
      Query: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.QueryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.QueryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface QueryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    /**
     * Find zero or more Queries that matches the filter.
     * @param {QueryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const query = await prisma.query.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
     */
    findRaw(args?: QueryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Query.
     * @param {QueryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const query = await prisma.query.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: QueryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  export interface Prisma__QueryClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    responses<T extends Query$responsesArgs<ExtArgs> = {}>(args?: Subset<T, Query$responsesArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ResponsePayload<ExtArgs>, T, "findMany"> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface QueryFieldRefs {
    ...
    readonly prompt: FieldRef<"Query", 'String'>
   ...
   * Query findRaw
   */
  export type QueryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Query aggregateRaw
   */
  export type QueryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export interface Prisma__ResponseClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    query<T extends QueryDefaultArgs<ExtArgs> = {}>(args?: Subset<T, QueryDefaultArgs<ExtArgs>>): Prisma__QueryClient<$Result.GetResult<Prisma.$QueryPayload<ExtArgs>, T, "findUniqueOrThrow"> | Null, Null, ExtArgs>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface ResponseFieldRefs {
    ...
    readonly queryId: FieldRef<"Response", 'String'>
    readonly provider: FieldRef<"Response", 'String'>
    readonly content: FieldRef<"Response", 'String'>
    readonly latencyMs: FieldRef<"Response", 'Int'>
  ...
  export type QueryWhereInput = {
    ...
    prompt?: StringFilter<"Query"> | string
  ...
  export type QueryScalarWhereWithAggregatesInput = {
    ...
    prompt?: StringWithAggregatesFilter<"Query"> | string
  ...
  export type ResponseWhereInput = {
    ...
    queryId?: StringFilter<"Response"> | string
    provider?: StringFilter<"Response"> | string
    content?: StringFilter<"Response"> | string
    latencyMs?: IntFilter<"Response"> | number
    createdAt?: DateTimeFilter<"Response"> | Date | string
    query?: XOR<QueryRelationFilter, QueryWhereInput>
  }
  ...
  export type ResponseScalarWhereWithAggregatesInput = {
    ...
    queryId?: StringWithAggregatesFilter<"Response"> | string
    provider?: StringWithAggregatesFilter<"Response"> | string
    content?: StringWithAggregatesFilter<"Response"> | string
    latencyMs?: IntWithAggregatesFilter<"Response"> | number
  ...
  export type QueryCreateInput = {
    ...
    prompt: string
    createdAt?: Date | string
    responses?: ResponseCreateNestedManyWithoutQueryInput
  }
  ...
  export type QueryUncheckedCreateInput = {
    ...
    prompt: string
    createdAt?: Date | string
    responses?: ResponseUncheckedCreateNestedManyWithoutQueryInput
  }

  export type QueryUpdateInput = {
    prompt?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    responses?: ResponseUpdateManyWithoutQueryNestedInput
  }

  export type QueryUncheckedUpdateInput = {
    prompt?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    responses?: ResponseUncheckedUpdateManyWithoutQueryNestedInput
  }
  ...
  export type QueryRelationFilter = {
    is?: QueryWhereInput
  ...
  export type ResponseCreateNestedManyWithoutQueryInput = {
    create?: XOR<ResponseCreateWithoutQueryInput, ResponseUncheckedCreateWithoutQueryInput> | ResponseCreateWithoutQueryInput[] | ResponseUncheckedCreateWithoutQueryInput[]
    connectOrCreate?: ResponseCreateOrConnectWithoutQueryInput | ResponseCreateOrConnectWithoutQueryInput[]
    createMany?: ResponseCreateManyQueryInputEnvelope
  ...
  export type ResponseUpdateManyWithoutQueryNestedInput = {
    create?: XOR<ResponseCreateWithoutQueryInput, ResponseUncheckedCreateWithoutQueryInput> | ResponseCreateWithoutQueryInput[] | ResponseUncheckedCreateWithoutQueryInput[]
    connectOrCreate?: ResponseCreateOrConnectWithoutQueryInput | ResponseCreateOrConnectWithoutQueryInput[]
    upsert?: ResponseUpsertWithWhereUniqueWithoutQueryInput | ResponseUpsertWithWhereUniqueWithoutQueryInput[]
    createMany?: ResponseCreateManyQueryInputEnvelope
    ...
    connect?: ResponseWhereUniqueInput | ResponseWhereUniqueInput[]
    update?: ResponseUpdateWithWhereUniqueWithoutQueryInput | ResponseUpdateWithWhereUniqueWithoutQueryInput[]
    updateMany?: ResponseUpdateManyWithWhereWithoutQueryInput | ResponseUpdateManyWithWhereWithoutQueryInput[]
  ...
  export type ResponseCreateOrConnectWithoutQueryInput = {
    where: ResponseWhereUniqueInput
    create: XOR<ResponseCreateWithoutQueryInput, ResponseUncheckedCreateWithoutQueryInput>
  }

  export type ResponseCreateManyQueryInputEnvelope = {
    data: ResponseCreateManyQueryInput | ResponseCreateManyQueryInput[]
  }

  export type ResponseUpsertWithWhereUniqueWithoutQueryInput = {
    where: ResponseWhereUniqueInput
    update: XOR<ResponseUpdateWithoutQueryInput, ResponseUncheckedUpdateWithoutQueryInput>
    create: XOR<ResponseCreateWithoutQueryInput, ResponseUncheckedCreateWithoutQueryInput>
  }

  export type ResponseUpdateWithWhereUniqueWithoutQueryInput = {
    where: ResponseWhereUniqueInput
    data: XOR<ResponseUpdateWithoutQueryInput, ResponseUncheckedUpdateWithoutQueryInput>
  }

  export type ResponseUpdateManyWithWhereWithoutQueryInput = {
    where: ResponseScalarWhereInput
    data: XOR<ResponseUpdateManyMutationInput, ResponseUncheckedUpdateManyWithoutQueryInput>
  }
